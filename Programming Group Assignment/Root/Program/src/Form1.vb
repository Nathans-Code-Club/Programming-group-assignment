...
Public Class Form1 
    Public Class Form1 
        ...
        Private Sub (sender As Object, e As EventArgs, txtLocation As TextBox, txtName As TextBox, txtSurname As TextBox, txtAge As TextBox, txtOccupation As TextBox) Handles backup.click
            ...
            Try 
                ...
                clientDetails(3) = txtOccupation.Text 
